...
import AuthService, { type ActivateAccountRequest } from "@/lib/auth-service"
...
function ActivateAccountForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Prepare the data for API request - using username instead of email
      const activationData: ActivateAccountRequest = {
        username: username, // Using username as the email field per your requirements
        token: token,
        password
      }
      
      // Call the API with the correct endpoint
      await AuthService.activateAccount(activationData)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <Card className="w-full max-w-md">        <CardHeader className="text-center bg-slate-50 border-b">
          ...
          <CardDescription>
            Please set your username and password to complete your account activation
          </CardDescription>
        </CardHeader>
        ...
        {success ? (
          <CardContent className="pt-6 pb-4">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <h2 className="text-xl font-medium">Account Activated Successfully!</h2>
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Loading activation details...</CardDescription>
        </CardHeader>
