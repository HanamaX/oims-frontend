  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Orphan Management - Read Only</h1>
          <p className="text-muted-foreground">
            View orphan details for this branch. Superadmins cannot edit this data.
          </p>
        </div>
      ...
      {filteredOrphans.length === 0 && (
        <div className="text-center py-10">
          <p className="text-muted-foreground">No orphans found matching your search.</p>
        </div>
      )}
    </div>
  )
