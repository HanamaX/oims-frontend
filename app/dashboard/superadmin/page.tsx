...
export default function SuperAdminDashboard() {
  ...
  useEffect(() => {
    // Only fetch data if user is authenticated and is a superadmin
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        try {
          // For superadmin, use the getAllNotifications endpoint
        ...
        <Card className="col-span-1">
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { title: "New branch added", branch: "Hillside Branch", time: "2 days ago" },
                { title: "Admin account created", branch: "Riverside Branch", time: "3 days ago" },
                { title: "System update completed", branch: "All branches", time: "5 days ago" },
                { title: "Fundraiser campaign approved", branch: "Downtown Branch", time: "1 week ago" },
                { title: "Inventory audit completed", branch: "Springfield Branch", time: "1 week ago" },
              ].map((activity, i) => (
