...
export default function SuperAdminOrphansPage() {
  ...
  const fetchOrphans = async () => {
    ...
    try {
      // For superadmin, use the getAllOrphans endpoint
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-x-6 gap-y-1 text-sm mt-1">
                      ...
                      {orphan.imageUrl && <span>Has Profile Image</span>}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2 lg:mt-0">
                    <Button 
                      variant="outline" 
                      size="sm" 
                      onClick={() => router.push(`/dashboard/superadmin/orphans/${orphan.publicId}`)}
                    >
